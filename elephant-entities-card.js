/* 🐘 Elephant Entity Card - COMPLETE FILE */
...
class ElephantEntityCardEditor extends HTMLElement {
  ...
  _attachListeners() {
    this.shadowRoot.querySelectorAll("[configValue]").forEach(el => {
      ...
      // 1. HA-TEXTFIELD (Name/Unit Override) - FIX APPLIED HERE
      // Listening for 'input' ensures typing works immediately
